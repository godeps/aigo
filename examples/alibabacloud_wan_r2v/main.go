...
func main() {
	...
	err := client.RegisterEngine("alibabacloud-wan-r2v", alibabacloud.New(alibabacloud.Config{
		Model:             alibabacloud.ModelWanReferenceVideo,
	...
	url, err := client.Execute(ctx, "alibabacloud-wan-r2v", graph)
	if err != nil {
		log.Fatal(err)
	}
